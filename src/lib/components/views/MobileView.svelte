...
<div class="h-full w-full flex flex-col">
	<div class=" w-full h-14 flex">
		...
		<input class="w-full px-4 text-xl focus:outline-none appearance-none bg-zinc-100" type="text" value="" placeholder="Untitled Note" />
	</div>

	<div
		bind:this={mdEditorViewNode}
		class={`h-[calc(100dvh)] w-full inline overflow-x-hidden whitespace-nowrap ${
			!mobileToggleView && 'overflow-y-hidden'
		}`}
	>
		<div
